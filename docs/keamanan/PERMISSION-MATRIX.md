...
| karyawan | `karyawan.lihat`, `karyawan.kelola`, `karyawan.status.kelola`, `karyawan.jabatan.kelola`, `karyawan.departemen.kelola`, `karyawan.outlet.kelola`, `karyawan.shift.kelola`, `karyawan.jadwal.kelola`, `karyawan.tukar-shift.kelola`, `karyawan.penilaian.kelola` |
| absensi | `absensi.presensi`, `absensi.istirahat`, `absensi.keterlambatan`, `absensi.lembur.lihat`, `cuti-izin.ajukan`, `absensi.koreksi.kelola`, `absensi.setujui`, `absensi.geofence`, `absensi.perangkat.validasi` (ALT-DEF-019/ALT-DEF-024/ALT-DEF-025: kode LAMA `absensi.koreksi` diganti `absensi.koreksi.kelola` - checklist `ALT-HR-015` tidak pernah mereferensikan kode tanpa akhiran `.kelola`, sama kelas gap ALT-DEF-040) |
